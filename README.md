...
MySecret's main menu looks like this, you can **create a new encrypted note**, **read an encrypted note**, **edit an encrypted note**, **encrypt a raw file**, **decrypt a encrypted file** or **change file password**.
```bash
